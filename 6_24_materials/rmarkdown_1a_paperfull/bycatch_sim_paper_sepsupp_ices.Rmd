...
Figure S2: Predictive performance of the ratio estimator (status quo) and two spatial modeling frameworks: generalized additive model (GAM) and random forests (RF).

Figure S3: Change in predictive performance (normalized RMSE) when adding fishing effort and spatial location as covariates in each model.

Figure S4: Predictive performance (normalized RMSE) for different levels of simulated observer coverage.

Figure S5: Performance of RF bias correction methods (percent error, PE, averaged across years 2011-2015).
...
fig_path <- "figures/fig2_premade.png"
# fig1 <- readPNG(fig1_path, native = TRUE, info = TRUE)
...
# fig2_path <- "figures/fig2_effort_bycatch/fig2_effort_bycatch_target_nozeros.png"
fig2_path <- "figures/fig2_effort_bycatch_target_nozeros.png"
# fig1 <- readPNG(fig1_path, native = TRUE, info = TRUE)
...
<!-- dat.true <- readRDS("figures/byyear.rds") -->

<!-- # new error with duplicated column names -->
<!-- # workaround: https://stackoverflow.com/questions/28549045/dplyr-select-error-found-duplicated-column-name -->
...
<!--   rtn -->
<!-- } -->
<!-- dat.true <- dat.true %>% validate.names -->
...
fig_path <- "figures/fig10_bycatch_rate_rmse.png"
knitr::include_graphics(fig_path)
```
